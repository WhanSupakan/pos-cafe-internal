...
func (_c *RoleCreate) check() error {
	...
	if _, ok := _c.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`models: missing required field "Role.description"`)}
	}
	if v, ok := _c.mutation.Description(); ok {
		if err := role.DescriptionValidator(v); err != nil {
			return &ValidationError{Name: "description", err: fmt.Errorf(`models: validator failed for field "Role.description": %w`, err)}
		}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
